...
Public Class Conexion
        ...
        Public Sub New()
            ...
            Console.Write("Ha habido un error al intentar conectar a la base de datos" + e.Message, "Error de Conexion")
        End Try
    ...
    Public Function mostrarUsuarios()
        ...
        Try
            ...
            While dr.Read
                    ...
                    objUsuario.numero_tarjeta = dr("Numero_tarjeta")
                    objUsuario.pin = dr("PIN")
                    objUsuario.saldo = dr("Saldo")
                    objUsuario.nombres = dr("Nombres")
                    objUsuario.apellidos = dr("Apellidos")
                    objUsuario.direccion = dr("Direccion")
                    objUsuario.fecha_alta = dr("FechaAlta")
                    objUsuario.tipo_usuario = dr("TipoUsuario")
